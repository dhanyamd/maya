...
class PropertySearchService: 
    """
    Serice for searching properties using Superlinked
    """
    def __init__(
        self,
    ...
    def _setup_app(self): 
        ...
        try: 
            ...
            logger.warning(f"Failed to setup with Qdrant: {e}")
            self._setup_with_in_memory()
    ...
    def _setup_with_in_memory(self):
